...
```
# 3.4 Ответ: В лексико-грамматическом поиске можно указывать только лексему или словоформу, ее признаки (семантические,грамматические). "Точный поиск",в свою очередь, расчитан на поиск точных слов и форм, содержащих несколько слов.
```
...
```
# 6.1 Лемм со счетной формой: 4 (час, шаг, шар, ряд)
```
